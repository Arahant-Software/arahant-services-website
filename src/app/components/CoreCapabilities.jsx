...
import { Cpu, Factory, ShieldCheck, Zap, Wrench, Flame, ClipboardList, Package } from "lucide-react";
import { FadeUp, StaggerContainer, StaggerChild, Counter } from "./ui/Motion";

const capabilities = [
  { title: "Industrial Automation", icon: Cpu, description: "PLC, HMI, SCADA, Motion Control, Vision & Robotics.", details: "Siemens, Rockwell, Omron, Mitsubishi & Beckhoff experts." },
  { title: "Process Automation", icon: Factory, description: "DCS, Batch Control & Data Acquisition Systems.", details: "PCS7, Yokogawa, Emerson for FMCG, dairy, beverage & chemicals." },
  ...
  { title: "Mechanical Installation", icon: Wrench, description: "Turnkey Line Installation Solutions.", details: "Conveyors, valve banks, pneumatics, hydraulics & precision alignment." },
  { title: "Welding Services", icon: Flame, description: "Certified Stainless Steel Fabrication.", details: "Pipework, platforms, ladders, walkways & purge welding." },
          ...
          {capabilities.map((item, index) => {
            ...
            return (
              <StaggerChild key={index}>
                <motion.div
                  whileHover={{ y: -8, backgroundColor: "#181818", borderColor: "rgba(249,115,22,0.2)", boxShadow: "0 20px 60px rgba(255,102,0,0.18)" }}
